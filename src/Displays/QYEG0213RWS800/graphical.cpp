...
void QYEG0213RWS800::drawPixel(int16_t x, int16_t y, uint16_t color) {
  // Rotate the pixel
  int16_t x1, y1;
  switch(rotation) {
    case 0:         // No rotation
...
void QYEG0213RWS800::setRotation(uint8_t r) {
...
uint16_t QYEG0213RWS800::getTextCenterX(const char* text) {
    int16_t offset_x(0), offset_y(0);
...
uint16_t QYEG0213RWS800::getTextCenterY(const char* text) {
    int16_t offset_x(0), offset_y(0);
    uint16_t width(0), height(0);
...
void QYEG0213RWS800::charBounds(unsigned char c, int16_t *x, int16_t *y, int16_t *minx, int16_t *miny, int16_t *maxx, int16_t *maxy) 
{
