...
// Constructor for SPI pin customization
    ...
    QYEG0213RWS800::QYEG0213RWS800(uint8_t pin_dc, uint8_t pin_cs, uint8_t pin_busy, uint8_t pin_sdi, uint8_t pin_clk, uint16_t page_height) : GFX(panel_width, panel_height) {
        // Store the config, and init
        this->pin_dc =  pin_dc;
        this->pin_cs = pin_cs;
        this->pin_busy = pin_busy;
