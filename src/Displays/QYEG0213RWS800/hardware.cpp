...
void QYEG0213RWS800::begin(const PageProfile profile,  void (*wake_callback)(void), void (*sleep_callback)(void)) {
...
void QYEG0213RWS800::update(bool blocking) {
	sendCommand(0x22);
	sendData(0xF7);
	sendCommand(0x20);
