...
void QYEG0213RWS800::drawPixel_Fullscreen(int16_t x, int16_t y, uint16_t color) {
...
bool QYEG0213RWS800::calculating_Fullscreen() {
...
void QYEG0213RWS800::writePage_Fullscreen() {
