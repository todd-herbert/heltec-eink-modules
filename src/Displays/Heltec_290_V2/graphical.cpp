...
void Heltec_290_V2::drawPixel(int16_t x, int16_t y, uint16_t color) {
...
void Heltec_290_V2::setFlip(FlipList::Flip flip) {
	this->imgflip = flip;
}
...
void Heltec_290_V2::setDefaultColor(uint16_t bgcolor) {
...
void Heltec_290_V2::clearPage(uint16_t bgcolor) {
...
void Heltec_290_V2::setCursorTopLeft(const char* text, uint16_t x, uint16_t y) {
	int16_t offset_x(0), offset_y(0);
	getTextBounds(text, 0, 0, &offset_x, &offset_y, NULL, NULL);
	setCursor(x - offset_x, y - offset_y);
}

uint16_t Heltec_290_V2::getTextWidth(const char* text) {
	int16_t x(0),y(0);
	uint16_t w(0);
...
uint16_t Heltec_290_V2::getTextHeight(const char* text) {
	int16_t x(0),y(0);
	uint16_t h(0);
...
uint16_t Heltec_290_V2::Bounds::Window::top() {
	switch (*m_rotation) {
...
uint16_t Heltec_290_V2::Bounds::Window::right() {
	switch (*m_rotation) {
		case RotationList::PINS_ABOVE:
			return *edges[R];
		case RotationList::PINS_LEFT:
...
uint16_t Heltec_290_V2::Bounds::Window::bottom() {
	switch (*m_rotation) {
		case RotationList::PINS_ABOVE:
			return *edges[B];
		case RotationList::PINS_LEFT:
...
uint16_t Heltec_290_V2::Bounds::Window::left() {
	switch (*m_rotation) {
		case RotationList::PINS_ABOVE:
			return *edges[L];
		case RotationList::PINS_LEFT:
...
size_t Heltec_290_V2::write(uint8_t c) 
{
...
void Heltec_290_V2::charBounds(unsigned char c, int16_t *x, int16_t *y, int16_t *minx, int16_t *miny, int16_t *maxx, int16_t *maxy) 
{
