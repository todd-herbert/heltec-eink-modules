...
bool Heltec_213Red_V2::calculating(RegionList::Region update_region, uint8_t left, uint8_t top, uint8_t width, uint8_t height) {
...
bool Heltec_213Red_V2::calculating(RegionList::Region update_region) {
