...
bool Heltec_213Red_V2::calculating_Windowed() {
...
void Heltec_213Red_V2::drawPixel_Windowed(int16_t x, int16_t y, uint16_t color) {
...
void Heltec_213Red_V2::writePage_Windowed() {
