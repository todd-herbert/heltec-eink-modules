...
// void Heltec_290_V2_BLUETAB::drawPixel_Fullscreen(int16_t x, int16_t y, uint16_t color) {
...
// bool Heltec_290_V2_BLUETAB::calculating_Fullscreen() {
...
// void Heltec_290_V2_BLUETAB::writePage_Fullscreen() {
