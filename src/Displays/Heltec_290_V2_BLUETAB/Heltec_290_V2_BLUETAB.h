...
///Declaration: Heltec_290_V2_BLUETAB_BLUETAB(  d/c pin  , cs pin , busy pin )
class Heltec_290_V2_BLUETAB : public GFX {

    //Consts
    //===================
    private:
        //These are correct for the Heltect 2.9" V2 w/ Blue Tab, but are still defined here for easy access
        ...
        //From Waveshare (not heltec), contains all the tricky electronicy setting stuff to allow partial refreshes.
        //Currently no offical heltec support for this display
        const unsigned char waveform_partial[30] = {
        ...
        const unsigned char waveform_full[30] = {
    ...
    public:
        ...
        Heltec_290_V2_BLUETAB( uint8_t pin_dc, uint8_t pin_cs, uint8_t pin_busy) : GFX(panel_width, panel_height),
                                                                                pin_dc(pin_dc), 
                                                                                pin_cs(pin_cs), 
                                                                                pin_busy(pin_busy)
