...
bool Heltec_290_V2_BLUETAB::calculating(RegionList::Region update_region, uint16_t left, uint16_t top, uint16_t width, uint16_t height) {
...
bool Heltec_290_V2_BLUETAB::calculating(RegionList::Region update_region) {
