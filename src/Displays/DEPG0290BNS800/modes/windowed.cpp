...
bool DEPG0290BNS800::calculating_Windowed() {
...
void DEPG0290BNS800::drawPixel_Windowed(int16_t x, int16_t y, uint16_t color) {
...
void DEPG0290BNS800::writePage_Windowed() {
