...
void DEPG0150BNS810::drawPixel(int16_t x, int16_t y, uint16_t color) {
    // Rotate the pixel
    int16_t x1, y1;
    switch(rotation) {
        case 0:         // No rotation
...
/// Set the image flip
void DEPG0150BNS810::setFlip(FlipList::Flip flip) {
...
void DEPG0150BNS810::setCursorTopLeft(const char* text, uint16_t x, uint16_t y) {
    int16_t offset_x(0), offset_y(0);
    getTextBounds(text, 0, 0, &offset_x, &offset_y, NULL, NULL);
    setCursor(x - offset_x, y - offset_y);
}

uint16_t DEPG0150BNS810::getTextWidth(const char* text) {
    int16_t x(0),y(0);
    uint16_t w(0), h(0);
...
uint16_t DEPG0150BNS810::getTextHeight(const char* text) {
    int16_t x(0),y(0);
    uint16_t w(0), h(0);
    getTextBounds(text, 0, 0, &x, &y, &w, &h);  // Need to keep x and y as they appear to be used internally by getTextBounds()
    return h;
...
uint16_t DEPG0150BNS810::getTextCenterX(const char* text) {
    int16_t offset_x(0), offset_y(0);
...
uint16_t DEPG0150BNS810::getTextCenterY(const char* text) {
    int16_t offset_x(0), offset_y(0);
    uint16_t width(0), height(0);
...
uint8_t DEPG0150BNS810::Bounds::Window::top() {
    return getWindowBounds(T);
}

uint8_t DEPG0150BNS810::Bounds::Window::right() {
    return getWindowBounds(R);
}

uint8_t DEPG0150BNS810::Bounds::Window::bottom() {
    return getWindowBounds(B);
}

uint8_t DEPG0150BNS810::Bounds::Window::left() {
    return getWindowBounds(L);
}

uint8_t DEPG0150BNS810::Bounds::Window::getWindowBounds(DEPG0150BNS810::Bounds::Window::side request) {
...
size_t DEPG0150BNS810::write(uint8_t c) 
{
...
void DEPG0150BNS810::charBounds(unsigned char c, int16_t *x, int16_t *y, int16_t *minx, int16_t *miny, int16_t *maxx, int16_t *maxy) 
{
