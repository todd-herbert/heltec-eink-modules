...
bool DEPG0150BNS810::calculating_Windowed() {
...
void DEPG0150BNS810::drawPixel_Windowed(int16_t x, int16_t y, uint16_t color) {
...
void DEPG0150BNS810::writePage_Windowed() {
