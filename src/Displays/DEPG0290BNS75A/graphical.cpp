...
void DEPG0290BNS75A::setRotation(uint8_t r) {
...
uint16_t DEPG0290BNS75A::getTextCenterX(const char* text) {
    int16_t offset_x(0), offset_y(0);
...
uint16_t DEPG0290BNS75A::getTextCenterY(const char* text) {
    int16_t offset_x(0), offset_y(0);
    uint16_t width(0), height(0);
...
uint16_t DEPG0290BNS75A::Bounds::Window::getWindowBounds(DEPG0290BNS75A::Bounds::Window::side request) {
