...
bool DEPG0290BNS75A::calculating(RegionList::Region update_region, uint16_t left, uint16_t top, uint16_t width, uint16_t height) {
...
bool DEPG0290BNS75A::calculating(RegionList::Region update_region) {
